...
# Membaca inputan suhu_awal dan kadar_air_awal
...
while True:
    ...
    if kadar_air_akhir < 14:
        ...
        data_fitur.append([massa, suhu_awal, kadar_air_awal, suhu_akhir, kadar_air_akhir])
...
# Menyimpan data fitur sebelum kadar air mencapai 14 ke dalam file CSV
filename = 'data_fitur.csv'
header = ['Massa', 'Suhu Awal', 'Kadar Air Awal', 'Suhu Akhir', 'Kadar Air Akhir']

with open(filename, 'w', newline='') as file:
    writer = csv.writer(file)
    writer.writerow(header)
    writer.writerows(data_fitur)

print("Data fitur sebelum kadar air mencapai 14 telah disimpan dalam file: {}".format(filename))